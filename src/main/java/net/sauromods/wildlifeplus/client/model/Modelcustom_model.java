package net.sauromods.wildlifeplus.client.model;
...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("wildlifeplus", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 22).addBox(-4.0F, -3.0F, -6.0F, 4.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 6)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -7.0F, 8.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 16.0F, 1.0F));
		PartDefinition front_leg_left = partdefinition.addOrReplaceChild("front_leg_left",
				CubeListBuilder.create().texOffs(30, 7).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 19.5F, -4.0F));
		PartDefinition front_leg_right = partdefinition.addOrReplaceChild("front_leg_right",
				CubeListBuilder.create().texOffs(30, 0).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 19.5F, -4.0F));
		PartDefinition back_leg_left = partdefinition.addOrReplaceChild("back_leg_left",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -0.5F, -1.5F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 19.5F, 5.5F));
		PartDefinition back_leg_right = partdefinition.addOrReplaceChild("back_leg_right",
				CubeListBuilder.create().texOffs(22, 22).addBox(-1.0F, -0.5F, -1.5F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 19.5F, 5.5F));
