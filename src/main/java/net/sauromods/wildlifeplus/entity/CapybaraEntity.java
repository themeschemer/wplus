...
public class CapybaraEntity extends TamableAnimal {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("jungle"), new ResourceLocation("river"),
			new ResourceLocation("swamp"));

	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(WildlifeplusModEntities.CAPYBARA, 20, 2, 4));
	}

	public CapybaraEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(WildlifeplusModEntities.CAPYBARA, world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new TemptGoal(this, 1, Ingredient.of(Items.MELON_SLICE), false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CapybaraEntity retval = WildlifeplusModEntities.CAPYBARA.create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.MELON_SLICE).contains(stack);
	}
	...
	public static void init() {
		SpawnPlacements.register(WildlifeplusModEntities.CAPYBARA, SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
